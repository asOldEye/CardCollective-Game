...
namespace GameLogic
{
    ...
    //        int power, int healthMax, int health, Deck<SoliderCard> soliders, Deck<SpellCard> spells, List<Modifier> modifiers = null)
    //    {
    //        Power = power;
    //        HealthMax = healthMax;
    //        Health = health;
    ...
    //    protected Deck<SoliderCard> soliders;
    //    /// <summary>
    ...
    //    {
    //        get { return soliders; }
    //        protected set { soliders = new Deck<SoliderCard>(value.ToArray()); }
    //    }
    //    /// <summary>
    //    /// Призывает солдата на поле
    //    /// </summary>
    //    /// <param name="card">Солдат из колоды игрока</param>
    //    public void CastSolider(SoliderCard card)
    //    {
    //        //TODO
    //    }
    //}
